...
export function AuthenticatedClient(key: string, secret: string, passphrase: string, apiUri = 'https://www.okex.com', timeout = 3000, axiosConfig = {}): any {
  ...
  const signRequest = (method: string, path: string, options: { readonly qs?: string; readonly body?: string } = {}) => {
  ...
  const getSignature = (method: string, relativeURI: string, opts: { readonly body?: string } = {}) => {
  ...
  async function get(url: string, params?: object): Promise<any> {
    return axiosInstance
      ...
      .then((res) => res.data)
      .catch((error) => {
        console.log(error.response && error.response !== undefined && error.response.data ? JSON.stringify(error.response.data) : error);
        console.log(error.message ? error.message : `${url} error`);
        throw error;
      });
  }

  async function post(url: string, body?: object, params?: object): Promise<any> {
  ...
  async function del(url: string, body?: object, params?: object): Promise<any> {
    const bodyJson = JSON.stringify(body);
    return axiosInstance
      .post(url, body, {
        headers: {
  ...
  return {
    get: (url: string, params?: any) => {
      if (params) return get(url + '?' + querystring.stringify(params));
      return get(url);
    },
    post,
    del,
    spot(): any {
      return {
        ...
        async postOrder(params: { readonly instrument_id: string; readonly client_oid?: string; readonly type: string; readonly side: string; readonly margin_trading?: number }): Promise<any> {
        ...
        async postCancelBatchOrders(params: [{ readonly instument_id: string; readonly order_ids: [string] }]): Promise<any> {
          return post(`/api/spot/v3/cancel_batch_orders`, params);
        },
        async getOrders(params: { readonly status: string; readonly instument_id: string; readonly from?: string; readonly to?: string; readonly limit?: string }): Promise<any> {
          return get(`/api/spot/v3/orders?` + querystring.stringify(params));
        },
        async getOrdersPending(params?: { readonly from?: string; readonly to?: string; readonly limit?: string; readonly instrument_id?: string }): Promise<any> {
          return get(`/api/spot/v3/orders_pending${params ? `?${querystring.stringify(params)}` : ''}`);
        },
        async getOrder(order_id: string, params: { readonly instrument_id: string }): Promise<any> {
          return get(`/api/spot/v3/orders/${order_id}?` + querystring.stringify(params));
        },
        async getFills(params: { readonly order_id: string; readonly instument_id: string; readonly from?: string; readonly to?: string; readonly limit?: string }): Promise<any> {
    ...
    account(): any {
      return {
        ...
        async getLedger(params?: { readonly currency?: string; readonly type?: number; readonly from?: number; readonly to?: number; readonly limit?: number }): Promise<any> {
    ...
    margin(): any {
      return {
        async getAccounts(instrument_id?: string): Promise<any> {
          return instrument_id ? get(`/api/margin/v3/accounts/${instrument_id}`) : get('/api/margin/v3/accounts');
        },
        ...
        async getAvailability(instrument_id?: string): Promise<any> {
          return instrument_id ? get(`/api/margin/v3/accounts/${instrument_id}/availability`) : get(`/api/margin/v3/accounts/availability`);
        },
        async getborrowed(
        ...
        async postBorrow(params?: { readonly instrument_id?: string; readonly currency?: number; readonly amount?: number }): Promise<any> {
          return post(`/api/margin/v3/accounts/borrow`, params);
        },
        async postRepayment(params?: { readonly instrument_id?: string; readonly currency?: number; readonly amount?: number; readonly borrow_id?: string }): Promise<any> {
    ...
    futures(): any {
      return {
        ...
        async postOrders(params: { readonly instrument_id: string; readonly orders_data: string; readonly leverage: number; readonly client_oid?: string }): Promise<any> {
        ...
        async getFills(params: { readonly order_id: string; readonly instrument_id: string; readonly from?: number; readonly to?: number; readonly limit?: number }): Promise<any> {
    ...
    swap(): any {
      return {
        ...
        async postBatchOrder(params: { readonly instrument_id: string; readonly order_data: string }): Promise<any> {
          return post('/api/swap/v3/orders', params);
        },
        async postCancelOrder(instrument_id: string, order_id: string): Promise<any> {
        ...
        async getFills(params: { readonly order_id: string; readonly instrument_id: string; readonly from?: string; readonly to?: string; readonly limit?: string }): Promise<any> {
    ...
    ett(): any {
      return {
        ...
        getOrders(params: { readonly status: string; readonly ett: string; readonly type: string; readonly from: string; readonly to: string; readonly limit: string }): Promise<any> {
