...
export function PublicClient(apiUri = 'https://www.okex.com', timeout = 3000, axiosConfig = {}): any {
  ...
  return {
    ...
    spot(): any {
      return {
        ...
        async getSpotBook(instrument_id: string, params?: { readonly size?: string; readonly depth?: string }): Promise<any> {
